(function (factory) {
	...
	*/
	...
	var ScrollTrigger$1 = /*#__PURE__*/function () {
	  ...
	  _proto.init = function init(vars, animation) {
	    ...
	    if (snap) {
	      ...
	      snapDurClamp = _isObject$1(snapDurClamp) ? _clamp$2(snapDurClamp.min, snapDurClamp.max) : _clamp$2(snapDurClamp, snapDurClamp);
	...
	const videoBlock = document.querySelectorAll(".Section-Content-Intro[data-video='even']");
	...
	ScrollTrigger$1.matchMedia({
	  "(min-width: 768px)": function () {
	    ...
	    const footerImg = gsapWithCSS.timeline({
	      scrollTrigger: {
